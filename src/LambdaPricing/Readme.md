...
```
dotnet new lambda.AspNetCoreWebAPI --profile <aws profile> --region <aws region>
```

Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *LambdaPricing*):
...
Execute unit tests
```
    cd "LambdaPricing/test/LambdaPricing.Tests"
    dotnet test
```

Deploy application
```
    cd "LambdaPricing/src/LambdaPricing"
